*************************************************************************
*
* README file for stlinkbridge utility - Linux version
*
*************************************************************************
...
b) libSTLinkUSBDriver.so - Shared library used to control STLINK bridges
...
- Copy libSTLinkUSBDriver.so to a directory included in the library search path.
  A reasonable place is /usr/local/lib.
